# Petrus Theron ([petrustheron.com](http://petrustheron.com/))
...
- [EACL](https://github.com/theronic/eacl) is a [ReBAC](https://en.wikipedia.org/wiki/Relationship-based_access_control) authorization library based on [SpiceDB](https://authzed.com/spicedb), built in Clojure & backed by Datomic.
